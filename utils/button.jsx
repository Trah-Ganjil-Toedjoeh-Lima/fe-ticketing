...
export const Button = ({ name, onClick, onMouseEnter, onMouseLeave }) => {
  return (
    <button
    ...
    >
      ...
      <span
        className='absolute inset-0 h-full w-full border-2 border-black bg-white group-hover:bg-black'
      ></span>
