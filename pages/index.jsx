            ...
            <div className='w-full'>
              <div className='py-12 text-center lg:text-left'>
                ...
                <p className='text-md mb-4 leading-normal text-gray-900 md:text-lg'>
                  ...
                  para penikmat musik dalam “Grand Concert Vol. 10: Anjangsana
                  Simfoni".
                  <br />
                  Anjangsana Simfoni berarti melepas rindu kidung masa kecil
                  melalui alunan simfoni orkestra oleh Gadjah Mada Chamber
                  Orchestra. Penampilan ini akan mengundang kembali
                  anggota-anggota yang telah maupun sedang berkarya di Gadjah
                  Mada Chamber Orchestra.
                </p>
                <a
            ...
            >
              <div className='py-12 text-center md:text-left lg:w-3/4'>
                ...
                <p className='mb-4 text-justify text-base font-light leading-normal opacity-80 md:text-lg'>
                  Addie MS adalah seorang musisi, konduktor, dan{" "}
                  <i>arranger </i>
                  terkenal asal Indonesia. Dia dikenal sebagai pendiri dan
                  konduktor dari Twilite Orchestra, yang telah tampil dalam
                  berbagai pertunjukan musik di dalam dan luar negeri.
                </p>
                <a
