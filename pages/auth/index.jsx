...
export default function index() {
  return (
    <section className="bg-gray-50 min-h-screen flex items-center justify-center">
      <div className="relative flex flex-wrap-reverse m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
        {/* leftside */}
        <div className=" flex flex-col justify-center p-8 md:p-14">
          ...
          <form action="">
            ...
            <button class="w-full bg-gmco-blue-main text-white p-2 rounded-lg mb-6 hover:bg-white hover:text-black hover:border hover:border-gray-300">
              Sign in
            </button>
          </form>
        </div>
        {/* right side */}
        <div class="relative md:mb-0 md:w-3/12 lg:w-4/12">
          <img
            src="/herotemp.jpg"
            alt=""
